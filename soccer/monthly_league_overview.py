...
class MonthlyLeagueOverview:
    ...
    def save_monthly_overview(self, league_data, start_date, end_date):
        ...
        # Save detailed CSV
        csv_filename = f"/Users/richardgibbons/soccer betting python/soccer/output reports/monthly_league_overview_{timestamp}.csv"
    ...
    def generate_formatted_monthly_report(self, league_data, start_date, end_date, timestamp):
        ...
        report_filename = f"/Users/richardgibbons/soccer betting python/soccer/output reports/monthly_league_report_{timestamp}.txt"
