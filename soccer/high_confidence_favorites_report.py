...
class HighConfidenceFavoritesReport:
    ...
    def save_favorites_report(self, favorites: List[Dict]):
        ...
        # Save text report
        report_file = f"/Users/richardgibbons/soccer betting python/soccer/output reports/high_confidence_favorites_{date_str}.txt"
        with open(report_file, 'w') as f:
            f.write(report_content)
        
        # Save CSV data
        csv_file = f"/Users/richardgibbons/soccer betting python/soccer/output reports/high_confidence_favorites_{date_str}.csv"
