...
class ComprehensiveBacktestGenerator:
    ...
    def save_backtest_report(self, all_picks, daily_summaries):
        ...
        picks_csv = f"/Users/richardgibbons/soccer betting python/soccer/output reports/comprehensive_backtest_picks_{timestamp}.csv"
        ...
        summary_csv = f"/Users/richardgibbons/soccer betting python/soccer/output reports/daily_backtest_summary_{timestamp}.csv"
    ...
    def generate_formatted_backtest_report(self, all_picks, daily_summaries, timestamp):
        ...
        report_filename = f"/Users/richardgibbons/soccer betting python/soccer/output reports/comprehensive_backtest_report_{timestamp}.txt"
