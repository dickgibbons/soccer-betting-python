...
class SeptemberEnhancedBacktest:
    ...
    def create_comparison_report(self, standard_picks, enhanced_picks):
        ...
        standard_df.to_csv('/Users/richardgibbons/soccer betting python/soccer/output reports/september_standard_backtest.csv', index=False)
        enhanced_df.to_csv('/Users/richardgibbons/soccer betting python/soccer/output reports/september_enhanced_backtest.csv', index=False)
...
"""
        ...
        # Save report
        report_file = '/Users/richardgibbons/soccer betting python/soccer/output reports/september_strategy_comparison.txt'
