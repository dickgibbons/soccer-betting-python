...
class RealBacktestGenerator:
    ...
    def save_backtest_data(self, picks):
        ...
        # Save to CSV
        output_file = f"/Users/richardgibbons/soccer betting python/soccer/output reports/backtest_report_aug01_sep09.csv"
...
"""
        ...
        # Save report
        report_file = f"/Users/richardgibbons/soccer betting python/soccer/output reports/backtest_performance_report.txt"
